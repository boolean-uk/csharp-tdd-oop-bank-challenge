...
//creating a user
User user3 = new User("Thanasakis", "test", "6999999", 1000m, AccountType.Saving);
//createing a bank
...
Transaction transaction = new Transaction(DateTime.Today, TransactionType.Credit, 500m,user3.balance);
bank.MakeTransaction(transaction, user3, bank.BankAccounts.ElementAt(0));

//creating transaction and making a transaction for a specific user 

Transaction transaction2 = new Transaction(DateTime.Now, TransactionType.Debit, 500m, user3.balance);
